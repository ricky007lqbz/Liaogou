 ...
 * <p>
 * Vertical LinearLayoutManager 左边边距
 * <p>
 * Horizontal  LinearLayoutManager 上边边距
 */
public class C_LeftOffsetItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public C_LeftOffsetItemDecoration(int offsetPx) {
        mOffsetPx = offsetPx;
    }
