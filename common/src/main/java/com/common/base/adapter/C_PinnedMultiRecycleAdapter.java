 ...
 * <p>
 * 专门用来处理带RecyclerView的fragment或activity的 含有挂定向 adapter
 * 可以直接传入holderHelpers来控制每个item的显示
 */
public class C_PinnedMultiRecycleAdapter<T extends C_BaseBean> extends C_MultiRecycleAdapter<T> implements StickyRecyclerHeadersAdapter {
    ...
    public C_PinnedMultiRecycleAdapter(Context context) {
        super(context);
    }

    public C_PinnedMultiRecycleAdapter(Context context, List<T> data) {
        super(context, data);
    }
