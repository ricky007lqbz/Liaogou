 ...
 */
public class C_IcsLinearLayout extends LinearLayout {
    ...
    public C_IcsLinearLayout(Context context, int themeAttr) {
        super(context);

        TypedArray a = context.obtainStyledAttributes(null, LL, themeAttr, 0);
        setDividerDrawable(a.getDrawable(C_IcsLinearLayout.LL_DIVIDER));
        mDividerPadding = a.getDimensionPixelSize(LL_DIVIDER_PADDING, 0);
        /**dong SHOW_DIVIDER_NONE=0 **/
