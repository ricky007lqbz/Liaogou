 ...
 */
public class C_StickyTabLayout extends LinearLayout implements NestedScrollingParent {
    ...
    public C_StickyTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onFinishInflate() {
        ...
        mNav = findViewById(R.id.id_stick_tab_top_ll);
        View view = findViewById(R.id.id_stick_tab_viewpager);
        if (!(view instanceof ViewPager)) {
            throw new RuntimeException("id viewpager of StickyNavLayout show used by ViewPager !");
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        params.height = getMeasuredHeight() - mNav.getMeasuredHeight() - mTopBannerHeight;
    ...
    //---------------------------下拉动画-------------------//
    public static final int ANIM_TYPE_CENTER = 0;
    public static final int ANIM_TYPE_TOP = 1;
    ...
    private void startPullAnim(float offsetY) {
        switch (animType) {
            case ANIM_TYPE_BOTTOM:
                //头部view的下拉动画
                mTopView.setPadding(0, 0, 0, (int) offsetY);
                //传入的头部背景view下拉动画
                if (mTopBgView != null) {
                    mTopBgView.setPadding(0, 0, 0, (int) offsetY);
                }
                break;
            case ANIM_TYPE_TOP:
                //头部view的下拉动画
                mTopView.setPadding(0, (int) offsetY, 0, 0);
                //传入的头部背景view下拉动画
                if (mTopBgView != null) {
                    mTopBgView.setPadding(0, (int) offsetY, 0, 0);
                }
                break;
